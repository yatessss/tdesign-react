...
export type overlayStyleProps = Pick<TdSelectInputProps, 'popupProps' | 'borderless' | 'autoWidth' | 'readonly' | 'onPopupVisibleChange'>

// 单位：px
const MAX_POPUP_WIDTH = 1000;

export default function useOverlayStyle(props: overlayStyleProps) {
  const { popupProps, borderless, autoWidth, readonly, onPopupVisibleChange } = props;
